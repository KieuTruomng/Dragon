    ...
    public class MenuManager : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject GuideUI; //Giao diện hướng dẫn
        ...
        public void GoToMainMenu()
        {
            ...
            GuideUI.SetActive(false); //Ẩn màn hình hướng dẫn
        ...
        public void Interact()
        {
            ...
            {
                if (currentPosition == 0) // Nếu chọn "Start Game"
                {
            ...
            else if (currentPosition == 1) // Nếu chọn "Guide"
                {
                    ShowGuideUI();
                }
            }
        ...
        public void ShowGuideUI()
        {
            selectLevelUI.SetActive(false);
            mainMenuUI.SetActive(false); // Ẩn menu chính
            GuideUI.SetActive(true); // Hiển thị GuideUI
        }
